...
import { getShopArmor, getEquipmentPrices } from '../../data/equipment/loadEquipment';
 ...
 */
export default function ArmorShop({ playerGold, playerLevel, playerRace, onPurchase }: ArmorShopProps) {
  const [selectedItemId, setSelectedItemId] = useState<string | null>(null);
  const [isModalOpen, setIsModalOpen] = useState(false);

  // Get all shop armor for the player's race
  const shopArmor = getShopArmor(playerRace);

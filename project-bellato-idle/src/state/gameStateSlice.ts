...
export const CLASS_TO_SUBCLASS_40: Record<CharacterClass, SubclassLevel40[]> = {
  [CHARACTER_CLASSES.WARRIOR]: [SUBCLASS_LEVEL_40.SHIELD_MILLER, SUBCLASS_LEVEL_40.ARMSMAN, SUBCLASS_LEVEL_40.BERSERKER],
  [CHARACTER_CLASSES.RANGER]: [SUBCLASS_LEVEL_40.HIDDEN_SOLDIER, SUBCLASS_LEVEL_40.SENTINEL, SUBCLASS_LEVEL_40.INFILTRATOR],
  [CHARACTER_CLASSES.SPIRITUALIST]: [SUBCLASS_LEVEL_40.ASTRALIST, SUBCLASS_LEVEL_40.WIZARD, SUBCLASS_LEVEL_40.HOLY_CHANDRA],
  [CHARACTER_CLASSES.SPECIALIST]: [SUBCLASS_LEVEL_40.MENTAL_SMITH, SUBCLASS_LEVEL_40.ARMORED_RIDER],
};
